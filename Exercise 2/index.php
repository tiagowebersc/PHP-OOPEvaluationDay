				...
				<form method="post" class="form-horizontal well well-sm">
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<select id="gender" name="gender" class="form-control input-md" required>
									<option value="Mlle" <?php echo $gender === "Mlle" ? "selected = 'true'" : ''; ?>>Mademoiselle</option>
									<option value="Mme" <?php echo $gender === "Mme" ? "selected = 'true'" : ''; ?>>Madame</option>
									<option value="M" <?php echo $gender === "M" ? "selected = 'true'" : ''; ?>>Monsieur</option>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-8">
								<input id="firstname" name="firstname" type="text" class="form-control input-md" value="<?php echo $firstName; ?>" required>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-4 control-label" for="lastname">Nom</label>
							<div class="col-md-8">
								<input id="lastname" name="lastname" type="text" class="form-control input-md" value="<?php echo $lastName; ?>" required>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input id="city" name="city" type="text" class="form-control input-md" value="<?php echo $city; ?>" required>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input id="birthdate" name="birthdate" type="text" placeholder="JJ-MM-AAAA" class="form-control input-md" value="<?php echo $birthdate; ?>" required>
